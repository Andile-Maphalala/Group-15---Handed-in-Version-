...
export class AddPropertyTypeComponent implements OnInit {  
  ...
  allemployees: Observable<PropertType[]>;  
  ...
  ngOnInit(): void {  
    this.updatePropertytypeForm = this.formbulider.group({  
      ...
      PROPERTYTYPEDESCRIPTION:['', [Validators.required]], 
      TIMESVISITED:['', [Validators.required]],   
    })  
  ...
  loadAllemployees() {  
    this.allemployees = this.PropertTypeService.getAllPropertType();  
  }  
  ...
  loademployeeToEdit(employeeId: string) {  
    this.PropertTypeService.getPropertTypeById(employeeId).subscribe(employees=> {  
      this.massage = null;  
      this.dataSaved = false;  
